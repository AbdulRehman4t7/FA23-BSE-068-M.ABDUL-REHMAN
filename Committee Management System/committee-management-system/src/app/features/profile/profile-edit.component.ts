  ...
  template: `
    <mat-card>
      <mat-card-content class="!p-6">
        <h1 class="font-heading text-2xl mb-4">Edit Profile</h1>
        <form [formGroup]="form" class="grid md:grid-cols-2 gap-3" (ngSubmit)="submit()">
          ...
          <button mat-raised-button class="md:col-span-2 !bg-navy !text-white" [disabled]="form.invalid">Save Changes</button>
        </form>
      </mat-card-content>
    </mat-card>
  `
